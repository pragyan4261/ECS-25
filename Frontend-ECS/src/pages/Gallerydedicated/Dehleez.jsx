...
const Dehleez = () => {
  ...
  return (
    <section className="relative max-w-7xl mx-auto items-center p-5">
      ...
      <button className="dehleez-button-prev-custom" onMouseEnter={handleMouseEnterPrev} onMouseLeave={handleMouseLeavePrev}>
        <img src={buttonImagePrev} alt="Prev" />
      </button>
      <button className="dehleez-button-next-custom" onMouseEnter={handleMouseEnterNext} onMouseLeave={handleMouseLeaveNext}>
