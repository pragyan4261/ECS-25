...
const Spectrum = () => {
  ...
  return (
    <section className="relative max-w-7xl mx-auto items-center p-5">
      ...
      <button className="spectrum-button-prev-custom" onMouseEnter={handleMouseEnterPrev} onMouseLeave={handleMouseLeavePrev}>
        <img src={buttonImagePrev} alt="Prev" />
      </button>
      <button className="spectrum-button-next-custom" onMouseEnter={handleMouseEnterNext} onMouseLeave={handleMouseLeaveNext}>
